...
class MoveChapterUpButton(QPushButton):
    ...
    def __init__(self):
        ...
        self.setIcon(GlobalFiles.UpIcon)
    ...
    def clicked_button(self):
        ...
        if current_index != 0 and current_index != -1:
            ...
            GlobalSetting.CHAPTER_FILES_LIST[current_index] = GlobalSetting.CHAPTER_FILES_LIST[current_index - 1]
            GlobalSetting.CHAPTER_FILES_LIST[current_index - 1] = temp_for_swap
